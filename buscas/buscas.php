...
<div   style="margin-top: 7%;margin-left: 2%">
    <table class="table table-striped table-responsive" >
        <thead>
            <tr><th>Nome da Maquina</th><th>Nome do Usuario</th><th>Ponto</th><th>MAC</th><th>Rack</th><th>Setor</th><th>Switch</th><th>Barramento</th><th>INV</th><th>Tombo</th><th>Editar</th><th>Excluir</th></tr>
        </thead>
        ...
        <tbody>
            ...
            while ($resultado = mysqli_fetch_assoc($resultados)) {
                ...
                echo "<td >" . utf8_encode($resultado['inv']) . "</td>";
                echo "<td >" . utf8_encode($resultado['tombo']) . "</td>";
