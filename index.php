    ...
    <form style="margin: 4% ; padding: 1.5%;margin-top: 10%;" method="post" action="inserts/insert_maquinas.php">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="nome_maquina" name="nome_maquina" placeholder="Nome da Máquina" required="">
            </div>
            <div class="form-group col-md-6">
                <label for="nome_usuario">Nome do Usuario</label>
                <input type="text" class="form-control" id="nome_usuario" name="nome_usuario" placeholder="Nome do Usuario" required="">
            </div>
        </div>
        <div class="form-group">
            <label for="ponto">Ponto</label>
            <input type="text" class="form-control" id="ponto" name="ponto" placeholder="PPxPTx" required="">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="mac" name="mac" placeholder="MAC Apenas numeros e letras" required="">
        </div>
        <div class="form-row">
